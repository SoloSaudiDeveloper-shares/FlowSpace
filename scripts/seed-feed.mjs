...
add("task_assigned", "Networking",          "Test team functionality assigned", "Owner: Admin.",                        4.5,  "normal")
...
add("comment_mention","NorthStar",          "Mentioned in NorthStar",           "@Admin — ready for your review.",      14.2, "normal")
